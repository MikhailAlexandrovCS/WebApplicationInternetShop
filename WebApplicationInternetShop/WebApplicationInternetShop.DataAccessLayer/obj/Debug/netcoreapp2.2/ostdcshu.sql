...
CREATE TABLE [AspNetUsers] (
    ...
    CONSTRAINT [FK_AspNetUsers_Customers_CustomerId] FOREIGN KEY ([CustomerId]) REFERENCES [Customers] ([ID]) ON DELETE CASCADE
);
...
CREATE TABLE [Orders] (
    ...
    [SHIPMENT_DATE] datetimeoffset NULL,
...
VALUES (N'20200208160218_InitialCreateTestingDb', N'2.2.4-servicing-10062');
